<div class="flex items-center gap-2">
    <div class="relative flex items-center gap-[8px] justify-center bg-[#27272a]/20 rounded-lg p-[2px]">
        <button
            ...
            onclick={onToggle}
        >
            <Icon size="16" class="text-[#9b87f5]"/>
        </button>
        ...
        <button
            ...
            title="Participate in Giveaways" tabindex="-1"
        >
            <Send size="14" class="text-green-500" />
        </button>

        {#if isTimerVisible}
            <div class="rounded-full border font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 absolute -top-[4px] -left-[8px] text-[10px] h-[12px] p-[4px] flex items-center justify-center bg-[#221F26] text-[#9b87f5] border-none font-mono">
...
let { Icon, isTimerVisible, isGameActive, timeout, onToggle }: Props = $props();
</script>
