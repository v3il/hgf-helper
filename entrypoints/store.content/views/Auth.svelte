<div class="uk-background-secondary uk-flex uk-flex-between uk-flex-middle uk-padding-small uk-panel hgf-bt-primary hgf-color-white">
    ...
    <button class="uk-button uk-button-primary" data-authorize on:click={triggerAuth}>Sign in with Twitch</button>
</div>
...
const authFacade: AuthFacade = Container.get(AuthFacade);
